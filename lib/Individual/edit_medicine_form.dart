...
class MedicineFormEdit extends StatefulWidget {
  ...
  const MedicineFormEdit({super.key, required this.medicationId});
  ...
  Future<Map<String, dynamic>?> loadData() async {
    ...
    for (QueryDocumentSnapshot snapshot in medicineSnapshots.docs) {
      ...
      _nameController.text =
          EncryptionDecryption.decryptAES(medication['name']);
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            // Handle the error case TOAST MSG
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    await FirebaseFirestore.instance
                                      ...
                                      for (var date =
                                        ...
                                        for (var key
                                            in medication.schedule.keys) {
                                          final value =
                                              medication.schedule[key];
                                          if (value != null &&
                                              value.isNotEmpty) {
