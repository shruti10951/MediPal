...
class InventoryScreenDependent extends StatefulWidget {
  const InventoryScreenDependent({super.key});

  @override
  _InventoryScreenDependentState createState() => _InventoryScreenDependentState();
}

class _InventoryScreenDependentState extends State<InventoryScreenDependent> {
